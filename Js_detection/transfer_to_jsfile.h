...
void read_write_file(int *words_count){
    printf("1111111111");
    FILE *input;
    char *inputname = "/Users/mcittkmims/Documents/SDA/Individual_Work/Js_detection/temp.txt"; 
    FILE *output;
    char *outputname = "/Users/mcittkmims/Documents/SDA/Individual_Work/Js_detection/output.txt"; 
