...
int main(){
    FILE *database;
    char *databasename = "/Users/mcittkmims/Documents/SDA/Individual_Work/C_detection/database.txt"; 
    database = fopen(databasename, "ab");
    FILE *code_file;
    char *code_filename = "/Users/mcittkmims/Documents/SDA/Individual_Work/C_detection/code_for_database.txt"; 
